    ...
    database["lapetus"] = {
      ...
      models: {
        "qwen3-coder-plus": {
          ...
          capabilities: { input: { text: true, audio: false, image: false, video: false, pdf: false }, output: { text: true, audio: false, image: false, video: false, pdf: false }, temperature: true, tool_call: true, interleaved: false },
          headers: {},
    ...
    database["lapetus-nvidia"] = {
      ...
      models: {
        ...
        "moonshotai/kimi-k2-instruct-0905": {
          ...
          temperature: true,
          tool_call: true,
          api: { id: "moonshotai/kimi-k2-instruct-0905", url: "https://integrate.api.nvidia.com/v1", npm: "@ai-sdk/openai-compatible" },
          options: {},
          limit: { context: 128000, output: 8192 },
          cost: { input: 0, output: 0, cache: { read: 0, write: 0 } },
          capabilities: { input: { text: true, audio: false, image: false, video: false, pdf: false }, output: { text: true, audio: false, image: false, video: false, pdf: false }, temperature: true, tool_call: true, interleaved: false },
        ...
        "moonshotai/kimi-k2-thinking": {
          ...
          temperature: true,
          tool_call: true,
          api: { id: "moonshotai/kimi-k2-thinking", url: "https://integrate.api.nvidia.com/v1", npm: "@ai-sdk/openai-compatible" },
          options: {},
          limit: { context: 128000, output: 8192 },
          cost: { input: 0, output: 0, cache: { read: 0, write: 0 } },
          capabilities: { input: { text: true, audio: false, image: false, video: false, pdf: false }, output: { text: true, audio: false, image: false, video: false, pdf: false }, temperature: true, tool_call: true, interleaved: false },
        ...
        "moonshotai/kimi-k2-instruct": {
          ...
          temperature: true,
          tool_call: true,
          api: { id: "moonshotai/kimi-k2-instruct", url: "https://integrate.api.nvidia.com/v1", npm: "@ai-sdk/openai-compatible" },
          options: {},
          limit: { context: 128000, output: 8192 },
          cost: { input: 0, output: 0, cache: { read: 0, write: 0 } },
          capabilities: { input: { text: true, audio: false, image: false, video: false, pdf: false }, output: { text: true, audio: false, image: false, video: false, pdf: false }, temperature: true, tool_call: true, interleaved: false },
