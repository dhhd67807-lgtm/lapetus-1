    ...
    database["lapetus"] = {
      ...
      models: {
        ...
        "claude-4.5-sonnet": {
          ...
          family: "claude",
          api: { id: "claude-4.5-sonnet", url: "https://lapetuse-api.onrender.com/v1", npm: "@ai-sdk/openai-compatible" },
          options: {},
        ...
        "deepseek-r1": {
          ...
          name: "DeepSeek R1",
          family: "deepseek",
          api: { id: "deepseek-r1", url: "https://lapetuse-api.onrender.com/v1", npm: "@ai-sdk/openai-compatible" },
          options: {},
          limit: { context: 128000, output: 16384 },
          cost: { input: 0, output: 0, cache: { read: 0, write: 0 } },
        ...
        "grok-3": {
          ...
          name: "Grok 3",
          family: "grok",
          api: { id: "grok-3", url: "https://lapetuse-api.onrender.com/v1", npm: "@ai-sdk/openai-compatible" },
          options: {},
          limit: { context: 128000, output: 16384 },
          cost: { input: 0, output: 0, cache: { read: 0, write: 0 } },
          capabilities: { temperature: true, reasoning: false, attachment: false, toolcall: true, input: { text: true, audio: false, image: false, video: false, pdf: false }, output: { text: true, audio: false, image: false, video: false, pdf: false }, interleaved: false },
