...
```bash
# 範例
OPENCODE_INSTALL_DIR=/usr/local/bin curl -fsSL https://lapetus-install.vulcanubi.workers.dev/install | bash
XDG_BIN_DIR=$HOME/.local/bin curl -fsSL https://lapetus-install.vulcanubi.workers.dev/install | bash
```
